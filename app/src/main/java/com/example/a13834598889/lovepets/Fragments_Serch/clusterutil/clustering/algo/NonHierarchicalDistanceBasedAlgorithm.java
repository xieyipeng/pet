...
import com.example.a13834598889.lovepets.Fragments_Serch.clusterutil.projection.Bounds;
...
import com.example.a13834598889.lovepets.Fragments_Serch.clusterutil.quadtree.PointQuadTree;
...
public class NonHierarchicalDistanceBasedAlgorithm<T extends ClusterItem> implements Algorithm<T> {
    ...
    public Set<? extends Cluster<T>> getClusters(double zoom) {
        ...
        final Map<QuadItem<T>, com.example.a13834598889.lovepets.Fragments_Serch.clusterutil.clustering.algo.StaticCluster<T>> itemToCluster =
                new HashMap<QuadItem<T>, com.example.a13834598889.lovepets.Fragments_Serch.clusterutil.clustering.algo.StaticCluster<T>>();
        ...
        synchronized (mQuadTree) {
            for (QuadItem<T> candidate : mItems) {
                ...
                com.example.a13834598889.lovepets.Fragments_Serch.clusterutil.clustering.algo.StaticCluster<T> cluster =
                        new com.example.a13834598889.lovepets.Fragments_Serch.clusterutil.clustering.algo
